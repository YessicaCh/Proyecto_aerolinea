...
class Flight(object):
    ...
    def __init__(self, cod_ruta: str, name: str, base_price: float, 
        ...
        self.sales_price_economic:float = round(self.base_price  + self.economic_price,2)
        self.sales_price_premium:float = round(self.base_price  + self.premium_price,2)
